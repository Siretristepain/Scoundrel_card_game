...
| interact_with_monster | self | Card | suppose that we previously check that the 'self' is a monster. Deals damage equal to monster's power to the Player by calling get_damage method.  | X |
